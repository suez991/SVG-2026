...
@onready var distorta = $Distorta
@onready var corretta = $Corretta
@onready var interact_area = $InteractArea
@onready var collide_area = $Collisione
...
func fix_object():
	...
	distorta.visible = false  
	corretta.visible = true  
	collide_area.disabled = false 
